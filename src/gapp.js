...
const web3_provider_port = process.env.PRODUCTION_WEB3_PROVIDER_PORT || 7545;
...
const srtContractAddress = "0x575Bcd3988B44bfeC7799D283593De28B00498a4";
// ******************************************************************** //
...
app.post('/sign', (req, res) => {
  ...
  try {
    ...
    const value = instance.pushDocument.call(docId, docSig);
